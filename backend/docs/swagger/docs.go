...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "请求响应 (Code=0 成功)",
                        "schema": {
                            "$ref": "#/definitions/mcpserver.GetMCPServerCountResp"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "mcpserver.GetMCPServerCountResp": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "状态码",
                ...
                "data": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/mcpserver.GetMCPServerCountRespData"
                        }
                    ]
                },
                "message": {
        ...
        "mcpserver.GetMCPServerCountRespData": {
            "type": "object",
            "properties": {
                "count": {
                    "description": "数量",
